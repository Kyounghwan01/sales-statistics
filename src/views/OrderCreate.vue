    ...
    <section class="create-user" v-loading="!userList.length && loading">
      ...
      <div class="name">
        ...
        <div class="input-group select-user" @click="showMemberList">
          <el-input v-model="keyword" :disabled="search" placeholder="이름 또는 전화번호 입력하세요"></el-input>
      ...
      <div class="registered-at">
        ...
        <div class="invalid-feedback">
          <span class="required" v-if="!$v.data.unitPrice.required">단가는 필수값 입니다</span>
        </div>
      </div>
      ...
      <div class="registered-at">
        ...
        <div class="invalid-feedback">
          <span class="required" v-if="!$v.data.count.required">갯수는 필수값 입니다</span>
        </div>
      </div>
